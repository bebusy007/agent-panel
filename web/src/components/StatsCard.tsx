  ...
  return (
    <div
      ...
      className={cn(
        ...
        'bg-card',
        isWarn ? 'border-warning/40 hover:border-warning/60' : 'border-border hover:shadow-e2',
    ...
    >
      <div className="relative p-4 flex flex-col h-full">
        ...
        {/* Value */}
        <div className="font-mono typo-h1 text-foreground tabular-nums">{value}</div>
        ...
        {hint && (
          <div className="mt-2 pt-2 border-t border-border/30">
            <div className="font-mono text-[11px] text-muted-foreground/70">{hint}</div>
          </div>
        )}
      </div>
    </div>
