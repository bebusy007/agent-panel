...
export const TYPO_LEVELS: TypoLevel[] = [
  { key: "h1",      label: "H1 页面标题",    hint: "概览、用量、会话…", cssVar: "--text-h1",      defaultPx: 24, min: 18, max: 32 },
  { key: "h2",      label: "H2 卡片标题",    hint: "Section / 对话框",  cssVar: "--text-h2",      defaultPx: 16, min: 13, max: 22 },
  { key: "body",    label: "Body 正文",       hint: "描述、列表项",      cssVar: "--text-body",    defaultPx: 14, min: 12, max: 18 },
  { key: "caption", label: "Caption 辅助",    hint: "时间戳、badge",     cssVar: "--text-caption", defaultPx: 12, min: 10, max: 16 },
  { key: "label",   label: "Label 标签",      hint: "UPPERCASE 小标题",  cssVar: "--text-label",   defaultPx: 11, min: 9,  max: 14 },
  { key: "sub",     label: "Sub 极辅助",      hint: "表头、微标注",      cssVar: "--text-sub",     defaultPx: 10, min: 8,  max: 13 },
];
