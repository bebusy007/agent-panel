...
import { cn, describeSessionSource, formatRelative, sourceColor } from '@/lib/utils';
...
export default function Dashboard() {
  ...
  const sessions = useAsync(() => api.sessionsList({ limit: 8 }), []);
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="rounded-xl border border-border bg-card p-5 transition-all hover:shadow-e2 flex flex-col">
          <div className="mb-3 flex items-center justify-between">
            <h2 className="typo-label">Skill 来源分布</h2>
            <button
              onClick={() => navigate('/skills')}
        ...
        <div className="rounded-xl border border-border bg-card p-5 transition-all hover:shadow-e2 flex flex-col">
          <div className="mb-3 flex items-center justify-between">
            <h2 className="typo-label">对话来源分布</h2>
            <button
              onClick={() => navigate('/sessions')}
              className="text-[10px] text-muted-foreground hover:text-primary transition-colors"
            >
