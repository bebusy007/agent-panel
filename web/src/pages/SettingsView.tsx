  ...
  return (
    <div className="space-y-8 animate-fade-in max-w-2xl">
      <header>
        ...
        <p className="mt-1 typo-body text-muted-foreground">自定义 Agent Panel 的外观和行为</p>
      </header>
        ...
        <div className="mt-4 rounded-lg border border-border/50 bg-background/30 p-4 space-y-3">
          ...
          <div className="rounded-lg border border-border bg-card p-4 space-y-3">
            ...
            <p className="text-sm text-foreground">
              Body · 这段文字展示正文字号，用于消息内容、列表项和描述文字。The quick brown fox jumps
              over the lazy dog.
            </p>
            <div className="flex items-center gap-3 flex-wrap">
              <span className="text-xs text-muted-foreground">
                Caption · 2026-05-12 15:30 · 12 条消息
              </span>
              <span className="inline-flex items-center rounded-full px-1.5 py-0.5 text-xs ring-1 ring-inset ring-emerald-400/30 text-emerald-400 font-medium">
                Claude Code
              </span>
            </div>
            ...
            <div className="flex items-center gap-3">
              <span className="text-[10px] text-muted-foreground">
                Sub · ~/workspace/skill-panel · 扫描 0.5s
              </span>
